...
const Home = () => {
    ...
    return (
        ...
        <div style={{justifyContent:"center", textAlign:"center"}}> <br/> <br/> <br/> <br/>
            <h1 style={{ color: "white",fontSize:"60px"  }} className="d-flex justify-content-center d-flex align-items-center"> <b> Nusrat Jahan Nisha</b></h1>
         ...
         <h5 style={{color:"white"}}>A hard working, experienced website developer studying in   Materials <br/> Science and Engineering.  Passionate  to   programming,  culture,<br/> sports and music. A dreamer who works day and night <br/> to achieve the peak she cherishes.</h5> <br/>
           ...
           <button onClick={handleMessage} type="button" class="btn btn-outline-light ml-2"> <b> Send Message</b> </button>
           ...
           <button type="button" class="btn btn-light ml-2"> <b> Download Resume</b></button>
                ...
                {/* <button type="button" class="btn btn-outline-light ml-2">Download Resume</button>  */}
        </div>
